...
import LocationSharing from "@/components/loadboard/LocationSharing";
  ...
  return (
    <ProtectedRoute allowedRoles={["TRANSPORTER", "ADMIN"]}>
      <main className="animate-fade-in p-6 min-h-screen">
        <header className="mb-6 bg-surface p-8 rounded-2xl shadow-sm border border-border flex justify-between items-center">
          <div>
