export const translations = {
  en: {
    ...
    nav_payouts: "Escrow Payouts",
    nav_disputes: "Dispute Center",
    nav_hubs: "Hub Management",
    nav_dispatch: "Trip Dispatch",
    nav_users: "User Management",
    nav_verification: "KYC Verification",
  ...
  ha: {
    ...
    nav_payouts: "Biyan Escrow",
    nav_disputes: "Wurin Takaddama",
    nav_hubs: "Gudanar da Hubs",
    nav_dispatch: "Aika Tafiya",
    nav_users: "Gudanar da Masu amfani",
    nav_verification: "Tabbatar da KYC",
  ...
  yo: {
    ...
    nav_payouts: "Awọn sisanwo Escrow",
    nav_disputes: "Ile-iṣẹ Takiti",
    nav_hubs: "Iṣakoso Hubs",
    nav_dispatch: "Fifiranṣẹ Irin-ajo",
    nav_users: "Iṣakoso Awọn Olumulo",
    nav_verification: "Ijẹrisi KYC",
  ...
  ig: {
    ...
    nav_payouts: "Nkwụghachi Escrow",
    nav_disputes: "Ebe Esemokwu",
    nav_hubs: "Nchịkwa Hubs",
    nav_dispatch: "Nzipu Njem",
    nav_users: "Nchịkwa Ndị Ọrụ",
    nav_verification: "Nkwenye KYC",
